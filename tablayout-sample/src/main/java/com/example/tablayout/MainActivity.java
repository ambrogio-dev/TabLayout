...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // TabLayoutManager setup:
        //  1. Optional: customize drawable (and text) tint colors.

        //tabLayout.setTabTextColors(Color.GRAY, Color.WHITE);

        //  2. call this instead of TabLayout#setupWithViewPager.
        TabLayoutManager.setupWithViewPager(tabLayout, mViewPager);
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter implements TabLayoutManager.IconPagerAdapter {
        ...
        public Drawable getPageTitleIconDrawableForTabPosition(int position) {
            ...
            switch (position) {
                case 0:
                    return  ContextCompat.getDrawable(getApplicationContext(),R.drawable.selector_tab_icon_demo);
                case 1:
                    return  ContextCompat.getDrawable(getApplicationContext(),R.drawable.selector_tab_icon_demo);
                case 2:
                    return ContextCompat.getDrawable(getApplicationContext(),R.drawable.selector_tab_icon_demo);
